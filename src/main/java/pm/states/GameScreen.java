...
public class GameScreen extends JPanel {
    ...
    private void drawString(Graphics g) {
        ...
        GraphPainter.drawString(g, "Level:", "Courier New", 1, 30, Color.WHITE, 0,
                new Rectangle(PacManGame.SCREEN_WIDTH * 810 / 960, PacManGame.SCREEN_HEIGHT * 50 / 960, PacManGame.SCREEN_WIDTH / 6, PacManGame.SCREEN_HEIGHT * 80 / 960));
        GraphPainter.drawString(g, "" + game.getCurrentLevel(), "Courier New", 1, 30, Color.WHITE, 1,
                new Rectangle(PacManGame.SCREEN_WIDTH * 780 / 960, PacManGame.SCREEN_HEIGHT * 80 / 960, PacManGame.SCREEN_WIDTH / 6, PacManGame.SCREEN_HEIGHT * 80 / 960));
        // score
        GraphPainter.drawString(g, "Score:", "Courier New", 1, 30, Color.WHITE, 0,
                new Rectangle(PacManGame.SCREEN_WIDTH * 810 / 960, PacManGame.SCREEN_HEIGHT * 150 / 960, PacManGame.SCREEN_WIDTH / 6, PacManGame.SCREEN_HEIGHT * 80 / 960));
        GraphPainter.drawString(g, "" + game.getPlayerScore(), "Courier New", 1, 30, Color.WHITE, 1,
                new Rectangle(PacManGame.SCREEN_WIDTH * 780 / 960, PacManGame.SCREEN_HEIGHT * 180 / 960, PacManGame.SCREEN_WIDTH / 6, PacManGame.SCREEN_HEIGHT * 80 / 960));
        // lives
        if (game.getLives() <= 1) {
            color = Color.RED;
        } else {
        ...
        GraphPainter.drawString(g, "Lives:", "Courier New", 1, 30, color, 0,
                new Rectangle(PacManGame.SCREEN_WIDTH * 810 / 960, PacManGame.SCREEN_HEIGHT * 250 / 960, PacManGame.SCREEN_WIDTH / 6, PacManGame.SCREEN_HEIGHT * 80 / 960));
        GraphPainter.drawString(g, "" + game.getLives(), "Courier New", 1, 30, color, 1,
                new Rectangle(PacManGame.SCREEN_WIDTH * 780 / 960, PacManGame.SCREEN_HEIGHT * 280 / 960, PacManGame.SCREEN_WIDTH / 6, PacManGame.SCREEN_HEIGHT * 80 / 960));
        // help
        if (game.isPaused()) {
            GraphPainter.drawString(g, "GAME PAUSE", "Courier New", 1, 100, Color.GREEN, 0,
                    new Rectangle(PacManGame.SCREEN_WIDTH * 200 / 960, PacManGame.SCREEN_HEIGHT * 400 / 960, PacManGame.SCREEN_WIDTH / 6, PacManGame.SCREEN_HEIGHT * 80 / 960));
            GraphPainter.drawString(g, "Play ('P')", "Courier New", 1, 20, Color.RED, 0,
                    new Rectangle(PacManGame.SCREEN_WIDTH * 840 / 960, PacManGame.SCREEN_HEIGHT * 930 / 960, PacManGame.SCREEN_WIDTH / 6, PacManGame.SCREEN_HEIGHT * 80 / 960));
        } else {
        ...
        GraphPainter.drawString(g, "Skip ('S')", "Courier New", 1, 20, Color.WHITE, 0,
                new Rectangle(PacManGame.SCREEN_WIDTH * 840 / 960, PacManGame.SCREEN_HEIGHT * 900 / 960, PacManGame.SCREEN_WIDTH / 6, PacManGame.SCREEN_HEIGHT * 80 / 960));
    }
