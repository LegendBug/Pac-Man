...
public class TextReader {
    private static final File file = new File("src/main/resources/map.txt");
    ...
    public static ArrayList<int[]> getComponents(char name) {
        ...
        try (BufferedReader reader = new BufferedReader(new FileReader(file))) {
            ...
            System.out.println("Please put \"map.txt\" under the folder \"Assignment\" (the same level as \"scores.txt\")");
            e.printStackTrace();
            return null;
        }
    }
